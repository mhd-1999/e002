<template>
        <div class="file-item">
            <img :src="docIcon" v-if="fileType=='application/vnd.openxmlformats-officedocument.wordprocessingml.document'"/>
            <img :src="pdfIcon" v-else-if="fileType=='application/pdf'"/>
            <img :src="excelIcon" v-else-if="fileType=='application/vnd.openxmlformats-officedocument.spreadsheetml.sheet'"/>
